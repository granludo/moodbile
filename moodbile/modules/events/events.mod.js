Moodbile.modules.events = {
    ...
    'auxFunc' : {
        'loadEvents' : function(data){
            var sortedData = [], len = null, courseid = null, courseids = null, coursename = null, currentItem = null, domStr = null, date = null, timeavailable = null, timemodified = null, timedue = null;
            ...
            $.each(sortedData, function(i, data){
                ...
                //Generate DOM for insert in details
                    ...
                    domStr += '<div class="timeavailable"><strong>'+Moodbile.t('timeavailable')+':</strong> <time datetime="'+data.timeavailable+'">' + timeavailable +'</time></div>';
                    domStr += '<div class="timedue"><strong> '+ Moodbile.t('timedue') +':</strong>  <time datetime="'+data.timedue+'">'+ timedue +'</time></div>';
                    domStr += '<div class="timemodified"><strong>'+ Moodbile.t('timemodified') +':</strong>  <time datetime="'+data.timemodified+'">'+ timemodified +'</time></div>';
