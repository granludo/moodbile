Moodbile.behaviorsPatterns.forum = function(){
    ...
    var delay = Math.floor(Math.random()*1000)+200; //TODO: Cambiar este sistema por un queue
    alert(delay);
    setTimeout(function(){
...
Moodbile.aux.forums = function(context, courseids) {
    $.each(courseids, function(){
        $('#wrapper').append('<section class="forums-'+ this +'"></section>');
        $('.events-'+ this).hide();
    });
    
    var op = 3;
    Moodbile.jsonRequest(context, op, Moodbile.templates.forums);
}
